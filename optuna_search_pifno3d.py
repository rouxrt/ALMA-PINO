...
from train_pifno3d import main
...
def objective(trial):
    ...
    print(f"Parameters: LR={lr:.5f}, Modes_xy={modes_xy}, Modes_z={modes_z}, Alpha={alpha:.3f}, Phys={lambda_phys:.3f}, Width={width}, BS={batch_size}")
    print(f"{'='*60}\n")
...
if __name__ == "__main__":
    plots_dir = os.path.join("optuna_results", "optuna_plots_pifno3d")
    ...
    study = optuna.create_study(
        study_name="pifno3d",
        storage="sqlite:///optuna_results/study_PIFNO3d.db", 
        load_if_exists=True,
        sampler=sampler,
